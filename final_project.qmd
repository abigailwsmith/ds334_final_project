...
|`fastball_avg_spin`|The average speed of fastballs for that pitcher in that season.|
|`fastball_avg_spin`|The average spin rate of fastballs for that pitcher in that season.|
...
* I didnt make a table of this data because I am not sure about it *
As a tentative tv viewership dataset I found this one on [kaggle](https://www.kaggle.com/datasets/mattop/world-series-baseball-television-ratings?resource=download) that covers just world series game viewership between 2022 and 2024. I am trying to find a better dataset that is general tv viewership and includes 2023. 
